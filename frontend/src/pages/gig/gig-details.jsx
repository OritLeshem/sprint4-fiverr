            ...
            <div className="gig-description">
                ...
                <div className="gig-about-seller">
                    ...
                    <div className="gig-about-seller-details">
                        <img className="gig-about-seller-img" src={gig.owner.imgUrl} alt="user-img" />
                        <div>
                            <p className="seller-fullname">{gig.owner.fullname}</p>
                            <p><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1792 1792" width="15" height="15">
                                <path fill="#ffb33e"
                                    d="M 1728 647 q 0 22 -26 48 l -363 354 l 86 500 q 1 7 1 20 q 0 21 -10.5 35.5 t -30.5 14.5 q -19 0 -40 -12 l -449 -236 l -449 236 q -22 12 -40 12 q -21 0 -31.5 -14.5 t -10.5 -35.5 q 0 -6 2 -20 l 86 -500 l -364 -354 q -25 -27 -25 -48 q 0 -37 56 -46 l 502 -73 l 225 -455 q 19 -41 49 -41 t 49 41 l 225 455 l 502 73 q 56 9 56 46 Z">
                                </path>
                ...
                <div className="gig-about-seller-container">
                    <ul className="seller-container-header">
                        <li>From</li>
                        <li>Avg. response time</li>
                        <li>Member since</li>
                        <li>Last delivery</li>
                    </ul>
                    <div className="seller-container-desc">
                        <p>I am a professional graphic designer with an experience of 10+ years. I am also expert in Website design/development as well as in UI/UX designs. Let my field of expertise collaborate with your level of imagination, so together we can create an exceptional brand image. Something which creates an impact. Impact which screams for its acknowledgment without you needing to do so. Let us make wonders together in this field of designing. Keep exploring.</p>
                    </div>
                </div>
            </div>
        </div>
