...
export function GigProgarm({ gig }) {
  return <div className="gig-program">
    ...
    <ul>
      <li ><span className="green-sheck fa-solid fa-check"></span> <span> 1 concept included </span></li>
      <li> <span className="green-sheck fa-solid fa-check"></span> <span>Include source file</span></li>
      <li><span className="fa-solid fa-check"></span> <span>Logo transparency </span></li>
      <li><span className="green-sheck fa-solid fa-check"></span> <span>Include 3D mockup</span></li>
      <li><span className="fa-solid fa-check"></span> <span>Vector file</span></li>
    </ul>
    <Link to={`/payment/:${gig._id}`}><button>Continue</button></Link>
